...
(* ReplicaSet.DeepCopy is generated by Kubernetes' deepcopy generator and is
   not translated. This is its ownership-preserving contract, in the same shape
   as [wp_Pod__DeepCopy] in the core/v1 counterpart. *)
Lemma wp_ReplicaSet__DeepCopy rs_l rs dq :
  {{{ is_pkg_init code.k8s_io.api.apps.v1.pkg_id.v1 ∗
      ReplicaSetV.deepown_l rs_l rs dq
  }}}
    rs_l @! (go.PointerType api_apps_v1.ReplicaSet) @! "DeepCopy" #()
  {{{ rs_copy_l, RET #rs_copy_l;
      ReplicaSetV.deepown_l rs_copy_l rs 1 ∗
      ReplicaSetV.deepown_l rs_l rs dq
  }}}.
Proof. Admitted.
