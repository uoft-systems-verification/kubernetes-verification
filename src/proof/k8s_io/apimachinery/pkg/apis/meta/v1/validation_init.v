...
#[global] Instance : IsPkgInit code.k8s_io.apimachinery.pkg.apis.meta.v1.validation.validation := define_is_pkg_init True%I.
#[global] Instance : GetIsPkgInitWf code.k8s_io.apimachinery.pkg.apis.meta.v1.validation.validation := build_get_is_pkg_init_wf.
