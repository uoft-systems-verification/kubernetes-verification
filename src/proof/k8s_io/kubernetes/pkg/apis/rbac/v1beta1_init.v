...
From New.proof.k8s_io.api.rbac Require Export v1beta1_init.
...
Context {sem : go.Semantics} {package_sem : v1beta1.Assumptions}.
Collection W := sem + package_sem.

#[global] Instance : IsPkgInit (iProp Σ) v1beta1 := define_is_pkg_init True%I.
#[global] Instance : GetIsPkgInitWf (iProp Σ) v1beta1 := build_get_is_pkg_init_wf.
