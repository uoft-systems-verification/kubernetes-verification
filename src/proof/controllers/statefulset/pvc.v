...
(* PersistentVolumeClaim.DeepCopy is generated by Kubernetes' deepcopy
   ...
   contract. *)
Lemma wp_PersistentVolumeClaim__DeepCopy_physical claim_template_l
    claim_template_phy claim_template dq_ptr dq :
  {{{ claim_template_l ↦{dq_ptr} claim_template_phy ∗
...
Proof.
  iIntros (Φ) "Hclaim_template HΦ".
  iDestruct "Hclaim_template" as
    (claim_template_phy) "[Hclaim_template_ptr Hclaim_template]".
  wp_apply (wp_PersistentVolumeClaim__DeepCopy_physical
