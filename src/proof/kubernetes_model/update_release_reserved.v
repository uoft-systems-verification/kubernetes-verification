...
Proof.
  ...
  destruct should_delete; wp_auto.
  {
    ...
    { rewrite Huid_eq.
      ...
      destruct (KObjectV.objectmeta kobj),
        (KObjectV.objectmeta updated_kobj); simpl in *.
      tauto. }
    iPoseProof (cview.own_auth_frag_lookup key old_kobj Hlookup_abs Hchild
      with "Hinv_Hown_children Hown_children_frag") as
      "%Hold_living_parent".
    ...
    { exact Hchild. }
    iMod (terminating_cview.delete_orphan_vs key old_kobj with
  ...
  assert (Hold_terminating_parent_none :
      terminating_cview.terminating_obj_parent_ref old_kobj = None).
  { unfold terminating_cview.terminating_obj_parent_ref.
    rewrite Hold_deletion_timestamp_none. done. }
  assert (Hnew_terminating_parent_none :
      terminating_cview.terminating_obj_parent_ref new_kobj = None).
  { unfold terminating_cview.terminating_obj_parent_ref.
  ...
  iMod (terminating_cview.simple_update_vs key old_kobj new_kobj with
    "Hinv_Hown_terminating_children") as
    "Hinv_Hown_terminating_children".
  { exact Hlookup_abs. }
