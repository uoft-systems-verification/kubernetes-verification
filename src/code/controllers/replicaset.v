...
{|
  pkg_imported_pkgs := [code.controllers.common.pkg_id.common; code.kubernetes_model.apimodel.pkg_id.apimodel; code.k8s_io.api.apps.v1.pkg_id.v1; code.k8s_io.api.core.v1.pkg_id.v1; code.k8s_io.apimachinery.pkg.api.errors.pkg_id.errors; code.k8s_io.apimachinery.pkg.apis.meta.v1.pkg_id.v1; code.k8s_io.kubernetes.pkg.controller.pkg_id.controller]
|}.
