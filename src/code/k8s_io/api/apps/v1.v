...
#[global] Instance info' : PkgInfo v1.v1 :=
  {|
    ...
    pkg_msets := msets';
    pkg_imported_pkgs := [code.k8s_io.api.core.v1.v1; code.k8s_io.api.core.v1.v1; code.k8s_io.apimachinery.pkg.apis.meta.v1.v1; code.k8s_io.apimachinery.pkg.apis.meta.v1.v1; code.k8s_io.api.core.v1.v1];
  |}.
