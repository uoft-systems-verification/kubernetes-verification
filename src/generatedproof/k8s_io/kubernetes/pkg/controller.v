...
Global Instance bounded_size_ActivePodsWithRanks : BoundedTypeSize controller.ActivePodsWithRanks.
Admitted.

Global Instance into_val_ActivePodsWithRanks `{ffi_syntax} : IntoVal ActivePodsWithRanks.t.
Admitted.

Global Instance into_val_typed_ActivePodsWithRanks `{ffi_syntax} : IntoValTyped ActivePodsWithRanks.t controller.ActivePodsWithRanks.
Admitted.
...
Global Program Instance is_pkg_defined_controller : IsPkgDefined controller :=
  {|
    is_pkg_defined_def go_ctx :=
      (is_pkg_defined_single controller)%I
  |}.
