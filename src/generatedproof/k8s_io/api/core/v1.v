...
From New.proof Require Import generated_struct.
...
Proof.
  pose (fields := ([
    build_generated_struct_field
      "Volumes" (go.SliceType v1.Volume)
      (fun v => v.(v1.PodSpec.Volumes'))
      (fun v x => v <|(v1.PodSpec.Volumes') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "InitContainers" (go.SliceType v1.Container)
      (fun v => v.(v1.PodSpec.InitContainers'))
      (fun v x => v <|(v1.PodSpec.InitContainers') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "Containers" (go.SliceType v1.Container)
      (fun v => v.(v1.PodSpec.Containers'))
      (fun v x => v <|(v1.PodSpec.Containers') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "EphemeralContainers" (go.SliceType v1.EphemeralContainer)
      (fun v => v.(v1.PodSpec.EphemeralContainers'))
      (fun v x => v <|(v1.PodSpec.EphemeralContainers') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "RestartPolicy" v1.RestartPolicy
      (fun v => v.(v1.PodSpec.RestartPolicy'))
      (fun v x => v <|(v1.PodSpec.RestartPolicy') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "TerminationGracePeriodSeconds" (go.PointerType go.int64)
      (fun v => v.(v1.PodSpec.TerminationGracePeriodSeconds'))
      (fun v x => v <|(v1.PodSpec.TerminationGracePeriodSeconds') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "ActiveDeadlineSeconds" (go.PointerType go.int64)
      (fun v => v.(v1.PodSpec.ActiveDeadlineSeconds'))
      (fun v x => v <|(v1.PodSpec.ActiveDeadlineSeconds') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "DNSPolicy" v1.DNSPolicy
      (fun v => v.(v1.PodSpec.DNSPolicy'))
      (fun v x => v <|(v1.PodSpec.DNSPolicy') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "NodeSelector" (go.MapType go.string go.string)
      (fun v => v.(v1.PodSpec.NodeSelector'))
      (fun v x => v <|(v1.PodSpec.NodeSelector') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "ServiceAccountName" go.string
      (fun v => v.(v1.PodSpec.ServiceAccountName'))
      (fun v x => v <|(v1.PodSpec.ServiceAccountName') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "DeprecatedServiceAccount" go.string
      (fun v => v.(v1.PodSpec.DeprecatedServiceAccount'))
      (fun v x => v <|(v1.PodSpec.DeprecatedServiceAccount') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "AutomountServiceAccountToken" (go.PointerType go.bool)
      (fun v => v.(v1.PodSpec.AutomountServiceAccountToken'))
      (fun v x => v <|(v1.PodSpec.AutomountServiceAccountToken') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "NodeName" go.string
      (fun v => v.(v1.PodSpec.NodeName'))
      (fun v x => v <|(v1.PodSpec.NodeName') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "HostNetwork" go.bool
      (fun v => v.(v1.PodSpec.HostNetwork'))
      (fun v x => v <|(v1.PodSpec.HostNetwork') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "HostPID" go.bool
      (fun v => v.(v1.PodSpec.HostPID'))
      (fun v x => v <|(v1.PodSpec.HostPID') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "HostIPC" go.bool
      (fun v => v.(v1.PodSpec.HostIPC'))
      (fun v x => v <|(v1.PodSpec.HostIPC') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "ShareProcessNamespace" (go.PointerType go.bool)
      (fun v => v.(v1.PodSpec.ShareProcessNamespace'))
      (fun v x => v <|(v1.PodSpec.ShareProcessNamespace') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "SecurityContext" (go.PointerType v1.PodSecurityContext)
      (fun v => v.(v1.PodSpec.SecurityContext'))
      (fun v x => v <|(v1.PodSpec.SecurityContext') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "ImagePullSecrets" (go.SliceType v1.LocalObjectReference)
      (fun v => v.(v1.PodSpec.ImagePullSecrets'))
      (fun v x => v <|(v1.PodSpec.ImagePullSecrets') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "Hostname" go.string
      (fun v => v.(v1.PodSpec.Hostname'))
      (fun v x => v <|(v1.PodSpec.Hostname') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "Subdomain" go.string
      (fun v => v.(v1.PodSpec.Subdomain'))
      (fun v x => v <|(v1.PodSpec.Subdomain') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "Affinity" (go.PointerType v1.Affinity)
      (fun v => v.(v1.PodSpec.Affinity'))
      (fun v x => v <|(v1.PodSpec.Affinity') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "SchedulerName" go.string
      (fun v => v.(v1.PodSpec.SchedulerName'))
      (fun v x => v <|(v1.PodSpec.SchedulerName') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "Tolerations" (go.SliceType v1.Toleration)
      (fun v => v.(v1.PodSpec.Tolerations'))
      (fun v x => v <|(v1.PodSpec.Tolerations') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "HostAliases" (go.SliceType v1.HostAlias)
      (fun v => v.(v1.PodSpec.HostAliases'))
      (fun v x => v <|(v1.PodSpec.HostAliases') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "PriorityClassName" go.string
      (fun v => v.(v1.PodSpec.PriorityClassName'))
      (fun v x => v <|(v1.PodSpec.PriorityClassName') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "Priority" (go.PointerType go.int32)
      (fun v => v.(v1.PodSpec.Priority'))
      (fun v x => v <|(v1.PodSpec.Priority') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "DNSConfig" (go.PointerType v1.PodDNSConfig)
      (fun v => v.(v1.PodSpec.DNSConfig'))
      (fun v x => v <|(v1.PodSpec.DNSConfig') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "ReadinessGates" (go.SliceType v1.PodReadinessGate)
      (fun v => v.(v1.PodSpec.ReadinessGates'))
      (fun v x => v <|(v1.PodSpec.ReadinessGates') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "RuntimeClassName" (go.PointerType go.string)
      (fun v => v.(v1.PodSpec.RuntimeClassName'))
      (fun v x => v <|(v1.PodSpec.RuntimeClassName') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "EnableServiceLinks" (go.PointerType go.bool)
      (fun v => v.(v1.PodSpec.EnableServiceLinks'))
      (fun v x => v <|(v1.PodSpec.EnableServiceLinks') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "PreemptionPolicy" (go.PointerType v1.PreemptionPolicy)
      (fun v => v.(v1.PodSpec.PreemptionPolicy'))
      (fun v x => v <|(v1.PodSpec.PreemptionPolicy') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "Overhead" v1.ResourceList
      (fun v => v.(v1.PodSpec.Overhead'))
      (fun v x => v <|(v1.PodSpec.Overhead') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "TopologySpreadConstraints" (go.SliceType v1.TopologySpreadConstraint)
      (fun v => v.(v1.PodSpec.TopologySpreadConstraints'))
      (fun v x => v <|(v1.PodSpec.TopologySpreadConstraints') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "SetHostnameAsFQDN" (go.PointerType go.bool)
      (fun v => v.(v1.PodSpec.SetHostnameAsFQDN'))
      (fun v x => v <|(v1.PodSpec.SetHostnameAsFQDN') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "OS" (go.PointerType v1.PodOS)
      (fun v => v.(v1.PodSpec.OS'))
      (fun v x => v <|(v1.PodSpec.OS') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "HostUsers" (go.PointerType go.bool)
      (fun v => v.(v1.PodSpec.HostUsers'))
      (fun v x => v <|(v1.PodSpec.HostUsers') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "SchedulingGates" (go.SliceType v1.PodSchedulingGate)
      (fun v => v.(v1.PodSpec.SchedulingGates'))
      (fun v x => v <|(v1.PodSpec.SchedulingGates') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "ResourceClaims" (go.SliceType v1.PodResourceClaim)
      (fun v => v.(v1.PodSpec.ResourceClaims'))
      (fun v x => v <|(v1.PodSpec.ResourceClaims') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "Resources" (go.PointerType v1.ResourceRequirements)
      (fun v => v.(v1.PodSpec.Resources'))
      (fun v x => v <|(v1.PodSpec.Resources') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve));
    build_generated_struct_field
      "HostnameOverride" (go.PointerType go.string)
      (fun v => v.(v1.PodSpec.HostnameOverride'))
      (fun v x => v <|(v1.PodSpec.HostnameOverride') := x|>)
      (ltac:(tc_solve)) (ltac:(tc_solve))
  ] : list (generated_struct_field v1.PodSpec.t v1.PodSpecⁱᵐᵖˡ))).
  assert (fields_unfold :
    v1.PodSpec'fds =→ generated_fields_decl fields).
  {
    constructor.
    unfold fields.
    rewrite /v1.PodSpec'fds seal_eq.
    reflexivity.
  }
  eapply (generated_struct_into_val_typed
    (fields_unfold:=fields_unfold) fields).
...
Proof.
  ...
  iDestruct "H" as "[H27 H]".
  iDestruct "H" as "[H28 H]".
  iDestruct "H" as "[H29 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H28 H]".
  iDestruct "H" as "[H29 H]".
  iDestruct "H" as "[H30 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H29 H]".
  iDestruct "H" as "[H30 H]".
  iDestruct "H" as "[H31 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H30 H]".
  iDestruct "H" as "[H31 H]".
  iDestruct "H" as "[H32 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 H32 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H31 H]".
  iDestruct "H" as "[H32 H]".
  iDestruct "H" as "[H33 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 H32 H33 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H32 H]".
  iDestruct "H" as "[H33 H]".
  iDestruct "H" as "[H34 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 H32 H33 H34 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H33 H]".
  iDestruct "H" as "[H34 H]".
  iDestruct "H" as "[H35 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 H32 H33 H34 H35 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H34 H]".
  iDestruct "H" as "[H35 H]".
  iDestruct "H" as "[H36 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 H32 H33 H34 H35 H36 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H35 H]".
  iDestruct "H" as "[H36 H]".
  iDestruct "H" as "[H37 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 H32 H33 H34 H35 H36 H37 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H36 H]".
  iDestruct "H" as "[H37 H]".
  iDestruct "H" as "[H38 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 H32 H33 H34 H35 H36 H37 H38 Hfield Hrest".
Qed.
...
Proof.
  ...
  iDestruct "H" as "[H37 H]".
  iDestruct "H" as "[H38 H]".
  iDestruct "H" as "[H39 H]".
  iDestruct "H" as "[Hfield Hrest]".
  iSplitL "Hfield"; first iExact "Hfield".
  iIntros "Hfield".
  iApply typed_pointsto_combine; first done.
  simpl. rewrite /named.
  iFrame "H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 H32 H33 H34 H35 H36 H37 H38 H39 Hfield Hrest".
Qed.
