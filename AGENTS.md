...
When running end-to-end tests, always stop every API server and etcd process
that you started for the test before finishing the task, including after a test
failure or interruption. Track the processes you start and clean up only those
processes; do not kill unrelated API server or etcd instances.
